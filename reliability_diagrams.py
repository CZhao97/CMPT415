...
def confidence_histogram_subplot(ax, bin_data, 
    ...
    if draw_averages:
        ...
        conf_plt = ax.axvline(x=bin_data["avg_confidence"], ls="dotted", lw=3, 
                              c="green", label="Avg. confidence")
        ax.legend(handles=[acc_plt, conf_plt])


def reliability_diagram_combined(bin_data, 
    ...
    reliability_diagram_subplot(ax[0], bin_data, draw_ece, draw_bin_importance, 
                                 title=title, xlabel="")

    # Draw the confidence histogram upside down.
    orig_counts = bin_data["counts"]
    bin_data["counts"] = -bin_data["counts"]
    confidence_histogram_subplot(ax[1], bin_data, draw_averages, title="")
...
def reliability_diagram(true_labels, pred_labels, confidences, num_bins=10,
    ...
    return reliability_diagram_combined(bin_data, draw_ece, draw_bin_importance,
